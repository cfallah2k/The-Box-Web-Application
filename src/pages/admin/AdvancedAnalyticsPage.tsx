            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-green-600">↗ {analyticsData.monthlyGrowth}%</p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-sm text-blue-800">Mobile development courses show 25% higher engagement. Consider expanding this category.</p>
              </div>
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center mb-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full mr-2"></div>
                  <span className="font-medium text-green-900">User Retention</span>
                </div>
                <p className="text-sm text-green-800">Users who complete 3+ courses have 85% retention rate. Focus on course completion.</p>
              </div>
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                <div className="flex items-center mb-2">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mr-2"></div>
                  <span className="font-medium text-purple-900">Revenue Optimization</span>
                </div>
                <p className="text-sm text-purple-800">Premium subscriptions generate 3x more revenue per user than individual course sales.</p>
              </div>
            </div>
          </div>
        </div>
